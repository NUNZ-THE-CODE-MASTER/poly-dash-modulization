...
// main.js
import { point} from './modules/point.js'; // Import the point class
import { positivMod, keepNDec } from './modules/utilitys.js'; // Import utility functions
  
import { vector } from './vector.js';
import { straightLine } from './straightLine.js';
import { segment } from './segment.js';
import { point } from './point.js'; // If point class is also in its own file
    ...
    drawGrid(gridInstance, heroInstance) {
      ...
      if (
        ...
        if (endingPosition != undefined) {
          this.drawTextNeonStyle("YOU WON!", 57, 255, 20, 1, 80, [
            endingPosition + 1 / 2,
            16,
          ]);
          if (checkpointCounter > 0) {
            this.drawTextNeonStyle(
              "CAN YOU DO IT WITHOUT CHECKpointS ?",
              224,
              231,
              34,
              1,
